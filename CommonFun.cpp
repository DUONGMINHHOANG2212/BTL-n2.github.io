...
#include "CommonFun.h"
//xử lí va chạm
bool SDLCommonFun::CheckCollision(const SDL_Rect& object1, const SDL_Rect& object2)
{
...
//khởi tạo show menu
int SDLCommonFun::ShowMenu(SDL_Renderer* g_screen, TTF_Font* font,
...
int SDLCommonFun::ShowMenuEnd(SDL_Renderer* g_screen, TTF_Font* font,
    const std::string& menu1,
    const std::string& img_name)
{
    char* ch1 = (char*)menu1.c_str();
